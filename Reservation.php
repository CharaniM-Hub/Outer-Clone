...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            echo '<h2>Reservation successful! Thank you!</h2>';
        } else {
...
<div class = "room-title">
        <h2 type = "Sub Title" class = "room">Book Room</h2>
      </div>
      ...
      <div class = "room-items">
       ...
       <div class = "room-item featured">
          ...
          <div class = "room-content">
            ...
            <h2 class = "food-time">Rs.8000 per Night</h2><br>
        ...
        <div class = "room-item featured">
          ...
          <div class = "room-content">
            ...
            <div class = "line"></div><br>
            <h2 class = "food-time">Rs.10000 per Night</h2><br>
            <p class = "category">For the simple room you get all the foods and drinks for this package.</p><br>
            <h3 class = "category">Features</h3>
